...
public class recordcreation {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.id("username"))).sendKeys("vaishnavi.koppula@vamritech.com.remsdev4");
        driver.findElement(By.id("password")).sendKeys("ySlchanel@vaish123");
