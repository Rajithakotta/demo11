...
WebDriverWait wait = new WebDriverWait(driver, Duration.ofMinutes(2));
		...
		Thread.sleep(6000);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[contains(@placeholder,'Search apps and items')]"))).sendKeys("Market Trends");
		Thread.sleep(3000);
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@name='Name']"))).sendKeys("Market");
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='slds-textarea']"))).sendKeys("trends");
