...
Thread.sleep(6000);
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[contains(@placeholder,'Search apps and items')]"))).sendKeys("My schemes");
Thread.sleep(3000);
...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@name='Name']"))).sendKeys("My");
 
 
 
 
 
WebElement dt =  wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@name='Date__c']")));
dt.click();
dt.sendKeys("Feb 25, 2023");
 
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='slds-textarea']"))).sendKeys("Scheme");
 
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@name='Read_More__c']"))).sendKeys("Schemes");
